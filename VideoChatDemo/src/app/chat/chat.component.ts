...
export class ChatComponent implements AfterViewInit {
  ...
  async call(): Promise<void> {
    ...
    try {
      ...
      this.dataService.sendMessager(
        {
          messageType:'offer',
          userData:{senderId :'loai',reciverId :'ahmed'} ,
    ...
    this.dataService.sendMessager(
      {
        ...
        userData:'loai' ,
        message:{type: 'registerUserName', data: 'loai'}
      } 
    );
...
//we will open the dialog to show the video chat streaming IsA
      ...
      this.dataService.sendMessager(
        {
          messageType:'answer',
          userData:'loai' ,
          message:{type: 'answer', data: this.peerConnection.localDescription}
        }
        );
  ...
  private createPeerConnection(): void {
    ...
    console.log('abdalla create connection');
  ...
  private handleICECandidateEvent = (event: RTCPeerConnectionIceEvent) => {
    ...
    if (event.candidate) {
      ...
      this.dataService.sendMessager({
          ...
          userData:'loai' ,
          message: {type: 'ice-candidate',data: event.candidate}
        }
        );
    }
  }
